...
public class First {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Roll:683480");
        System.out.println("Institue:FCI");
        System.out.println("Regestration: 683480");
    }
}
 */
...
public class First {
    ...
    public static void main(String[] args) {
        System.out.println("Tohidul Islam \n Roll:683480 \n Institue:FCI \n Regestration: 683480 ");
    }
}
...
public class First {
    ...
    public static void main(String[] args) {
        ...
        int number;
        System.out.println("Enter type your number");
        number = my.nextInt();
...
import java.util.Scanner;
 ...
 public class First {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The number 2 is : " );
...
public class First {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("The subtruction is : "+subtruction);            
        }
 }
 */
